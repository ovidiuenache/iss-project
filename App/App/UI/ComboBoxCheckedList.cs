...
namespace App.UI
{ /// <summary>
  /// This class is not made by me, but it's the only solution I found
  /// Don't waste too much time to understand what happens here
  /// Summary: it overrides some of combobox and checkedlist methods to get the wonderful ComboBoxCheckedList
  /// I used ComboBoxCheckedList like a tool for form that's why you won't find it in the code
  /// </summary>
    public class ComboBoxCheckedList : ComboBox
    {
        /// <summary>
        ...
        internal class Dropdown : Form
        {
            ...
            internal class CustomCheckedListBox : CheckedListBox
            {
                ...
                protected override void OnKeyDown(KeyEventArgs e)
                {
                    ...
                    {
                        // Enact selection.
                        ((ComboBoxCheckedList.Dropdown)Parent).OnDeactivate(new CCBoxEventArgs(null, true));
                        e.Handled = true;
                    ...
                    {
                        // Cancel selection.
                        ((ComboBoxCheckedList.Dropdown)Parent).OnDeactivate(new CCBoxEventArgs(null, false));
                        e.Handled = true;
            ...
            private ComboBoxCheckedList ccbParent;
            ...
            public Dropdown(ComboBoxCheckedList ccbParent)
            {
        ...
        public ComboBoxCheckedList() : base()
        {
